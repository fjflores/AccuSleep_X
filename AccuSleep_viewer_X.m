function [message] = AccuSleep_viewer_X(EEG, EMG, SR, epochLen, userLabels, savepath)
%AccuSleep_viewer_X A GUI for manually assigning sleep stage labels to EEG/EMG data.
%   Zeke Barger 021321
%   Arguments:
...
%             AccuSleep_GUI_X uses this argument, but if you are calling this
...
if nargin == 6 % this probably only happens when called by AccuSleep_GUI_X
...
WIN = figure('Units', 'Normalized', 'CloseRequestFcn',@closeReq,...
    ...
    'Menubar', 'none','Color', 'w', 'Name', 'AccuSleep_viewer_X');
...
% better know your keyboard shortcuts :D
